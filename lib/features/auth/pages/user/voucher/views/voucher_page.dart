...
class _VoucherPageState extends State<VoucherPage> {
  ...
  String getPromotionName(
    List<VoucherModel> promotionVouchers,
  ) {
  ...
  void showVoucherSelection(
    ...
    final promotionName =
        getPromotionName(promotionVouchers);

    final color =
        getVoucherColor(promotionName);
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              ...promotionVouchers.map(
                (voucher) {
                  return _buildVoucherOption(
                    voucher,
                    color,
                  );
                },
  ...
  Widget _buildHomeVoucherCard(
    ...
    final promotionCode =
        getPromotionCode(promotionVouchers);
